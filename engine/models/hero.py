...
NORMAL_HEROES: T.List[Hero] = [
    ...
    Hero(name='Janine', ability_name='Ninjutsu Art of Substitution', _power = KogaNinja, showdown_avatar ="koga"),
    Hero(name='Koga', ability_name='Ninjutsu Art of Summoning', _power = JanineJutsu, showdown_avatar = "janine"),
