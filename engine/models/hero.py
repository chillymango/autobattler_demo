...
NORMAL_HEROES: T.List[Hero] = [
    ...
    Hero(name='Janine', ability_name='Ninjutsu Art of Substitution', _power = JanineJutsu, showdown_avatar ="janine"),
    Hero(name='Koga', ability_name='Ninjutsu Art of Summoning', _power = KogaNinja, showdown_avatar = "koga"),
    ...
    Hero(name='Jessie and James', ability_name='Blast Off!!', _power = RocketHeist, showdown_avatar = 'teamrocket'),
