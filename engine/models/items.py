    ...
    def stone_evo(self):
        ...
        if holder.name == PokemonId.eevee:
            if PokemonType.water in self._target_type:
                self.eve_volve(evo = "vaporeon", pokemon = holder, evo_name = PokemonId.vaporeon)
            elif PokemonType.fire in self._target_type:
                self.eve_volve(evo = "flareon", pokemon = holder, evo_name = PokemonId.flareon)
            elif PokemonType.electric in self._target_type:
                self.eve_volve(evo = "jolteon", pokemon = holder, evo_name = PokemonId.jolteon)
            return
