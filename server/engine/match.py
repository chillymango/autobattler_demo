...
class Match(_Synchronized):
    ...
    def to_dict(self):
        return {"players": self.players, "result": self.result}

    @classmethod
    def from_dict(cls, dict_repr):
        match = cls(*dict_repr.pop("players"))
        match._result = dict_repr.pop("result")
        if dict_repr:
            print("Warning: received extra keys for Match: {}".format(dict_repr))
