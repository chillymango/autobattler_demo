...
requireScript('render_battledata.js?a7');
...
requireScript('render_battle.js');
...
var Replays = {
	...
	changeSetting: function (type, value, valueElem) {
		...
		case 'speed':
			...
			this.battle.messageDelay = 1;
      this.battle.messageFadeTime = 1000;
      this.battle.messageShownTime = 10;
